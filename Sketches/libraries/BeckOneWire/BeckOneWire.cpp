...
const DeviceAddress		acOneWireV40							= {0x28, 0xFF, 0xBA, 0xB4, 0xA0, 0x16, 0x05, 0xAA};
const DeviceAddress		acOneWireV41							= {0x28, 0xFF, 0x80, 0xF8, 0xA0, 0x16, 0x03, 0xBC};
const DeviceAddress		acOneWireV42							= {0x28, 0xFF, 0x37, 0xC4, 0xA0, 0x16, 0x04, 0x7B};
const DeviceAddress		acOneWireV43							= {0x28, 0xFF, 0x03, 0xAF, 0xA0, 0x16, 0x05, 0xBA};
...
BeckOneWire::BeckOneWire(int16 sOneWirePin) {
	OneWire      oOneWire(sOneWirePin);
