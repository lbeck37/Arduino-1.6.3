...
void setup() {
  Serial.begin(115200);
  Serial.println("\nBeckE32_HX711.ino, Apr 20, 2018-p");
...
*/
  ...
  Serial.println("setup(): Call oPedalForce.begin()");
  oPedalForce.begin(cHX711_DOUT, cHX711_SCK);		//Use default gain
  Serial.println("setup(): Back from oPedalForce.begin()");

  Serial.println("setup(): Call oPedalForce.read()");
  Serial.print("read: \t\t");
  ...
  Serial.println(oPedalForce.get_units(5), 1);	// print the average of 5 readings from the ADC minus tare weight (not set) divided
  ...
  Serial.print("get value: \t\t");
  Serial.println(oPedalForce.get_value(5));		// print the average of 5 readings from the ADC minus the tare weight, set with tare()

  Serial.print("get units: \t\t");
  Serial.println(oPedalForce.get_units(5), 1);        // print the average of 5 readings from the ADC minus tare weight, divided
