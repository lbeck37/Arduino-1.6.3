...
! See Select pg 101,Generates a new screen with a list of choices (type$[]). When
! the user taps a screen line, the index of the selected line is returned in type.
! Pressing the Back button returns 0. title$ goes at the top.
