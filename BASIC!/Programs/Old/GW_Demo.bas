...
IF !main THEN
  ...
  GW_ADD_TEXT (main, "&copy; Nicolas MOUGIN, 2014-2016")
...
DO
  ...
  ELSEIF LEFT$ (r$, 3) = "IL_" THEN % INPUTLIST events
    ...
    r$ = MID$ (r$, 4)
    IF r$ = "RESET" THEN
      POPUP "Listener triggered:" + CHR$(10) + "input list was reset"
    ELSEIF LEN (r$) = 1 THEN
      os$ = os$ [VAL (r$)]
    ...
    END IF
  END IF
  IF r$ = "SB_CHANGED" THEN POPUP "Listener triggered:" + CHR$(10) + "select box was changed"
